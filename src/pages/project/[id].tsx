...
const projectsFullData: Record<string, Project> = {
  'whatsapp-platform': {
      ...
      timeline: [
        {
          ...
          description:
            'Built core platform components including real-time chat, WhatsApp automation, multi-tenant management',
          highlights: [
            'Migrated Firebase to Supabase',
            'Implemented custom CDC with Golang',
            'Developed K8s automation',
          ],
        },
        {
          phase: 'Phase 2: Architectural Transformation',
          description:
            'Complete redesign focusing on shared resources and efficient scaling',
          highlights: [
      ...
      keyFeatures: [
        {
          ...
          description:
            'Transformed from dedicated PostgreSQL per customer to single managed PostgreSQL with schema-per-tenant',
          impact: 'Significant reduction in database infrastructure costs',
        },
        {
          title: 'Service Decentralization',
          description:
            'Decomposed monolith into specialized microservices with clear boundaries',
          services: [
        ...
        },
        {
          ...
          description:
            'Replaced Redis Streams with NATS JetStream for reliable message processing',
          benefits: [
    ...
    lessons: `This project demonstrated that architectural decisions directly impact business viability.
      ...
      choosing technology that scales, prioritizing observability and debugging capabilities,
      ...
      timeline: [
        {
          ...
          description:
            'Core system development with barcode tracking and basic workflows',
          highlights: [
      ...
      keyFeatures: [
        {
          ...
          description:
            'Digitized entire tool lifecycle with barcode-based identification',
          impact:
            '100% visibility of tool location and status across facilities',
        },
        {
          title: 'Multi-Platform Solution',
          description:
            'Web application for engineers and mobile app for operators',
          components: [
        ...
        },
        {
          ...
          description:
            'Replaced printed specifications with searchable digital catalog',
          benefits: [
            'Instant access to tool specs',
            'Version control',
            'Easy updates',
          ],
        },
        {
          ...
          description:
            'Digital approval system for document changes and standard updates',
          features: [
      ...
      keyFeatures: [
        {
          ...
          description:
            'Interactive Gantt chart for scheduling preventive maintenance',
          features: [
        ...
        },
        {
          ...
          description:
            'Mobile interface for technicians to log actual maintenance',
          capabilities: [
        ...
        },
        {
          ...
          description:
            'Digital repair request workflows with priority management',
          benefits: [
  ...
  'bni-sei': {
    ...
    solution: {
      ...
      techStack: {
        ...
        dataprocessing: [
          'Excel parsing libraries for reliable data extraction',
        ],
...
const ProjectDetailPage: React.FC = () => {
  ...
  const project = useMemo(
    () => projectsFullData[id as keyof typeof projectsFullData],
    [id],
  );
  ...
  if (!project) {
    return (
      <div className="section">
        <div
          className="container"
          style={{ maxWidth: 1200, textAlign: 'center', padding: '100px 20px' }}
        >
      ...
      <div style={{ position: 'relative' }}>
        ...
        {!isMobile && (
          ...
          >
            ...
            >
              <Anchor affix={false} offsetTop={80} style={{ fontSize: 14 }}>
        ...
        <div className="container" style={{ maxWidth: 1000 }}>
          ...
          <Card id="tech" style={{ marginBottom: 24 }}>
            ...
            <Row gutter={[16, 16]}>
              {Object.entries(project.solution.techStack).map(
                ([category, items]) => (
