...
const AboutPage: React.FC = () => {
  ...
  const experiences = [
      ...
      children: (
        <div>
          ...
          <Text type="secondary" style={{ fontSize: '14px' }}>
            Current Company • January 2025 - Present
          </Text>
          <Paragraph style={{ marginTop: '8px', marginBottom: '8px' }}>
            Leading technical strategy and architecture decisions with focus on
            backend systems and business impact.
          </Paragraph>
          <div>
    ...
    },
    {
      ...
      children: (
        <div>
          ...
          <Text type="secondary" style={{ fontSize: '14px' }}>
            Current Company • 2021 - December 2024
          </Text>
          <Paragraph style={{ marginTop: '8px', marginBottom: '8px' }}>
            Made strategic technical decisions that progressively improved
            system reliability and performance. Naturally evolved toward backend
            specialization while maintaining full-stack capabilities.
          </Paragraph>
          <div>
    ...
    },
    {
      ...
      children: (
        <div>
          ...
          <Paragraph style={{ marginTop: '8px', marginBottom: '8px' }}>
            Delivered end-to-end solutions for enterprise clients including
            Yamaha and BNI. Focused on understanding business processes to build
    ...
    },
    {
      ...
      children: (
        <div>
          <Title level={4} style={{ marginBottom: '4px' }}>
            Teaching Assistant & Business Analyst
          </Title>
          <Text type="secondary" style={{ fontSize: '14px' }}>
            Project-Based • Sep 2018 - Jan 2019
          </Text>
          <Paragraph style={{ marginTop: '8px', marginBottom: '8px' }}>
            Taught programming fundamentals to 20+ students while applying
            analytical skills in business context. This dual role strengthened
            my ability to communicate complex concepts simply.
          </Paragraph>
          <div>
    ...
    },
    {
      ...
      children: (
        <div>
          ...
          <Text type="secondary" style={{ fontSize: '14px' }}>
            GarageScript (c0d3.com) • July - August 2018
          </Text>
          <Paragraph style={{ marginTop: '8px', marginBottom: '8px' }}>
            Intensive bootcamp that transformed my engineering mindset into
            practical coding skills. The beginning of my journey from Civil
  ...
  const techStack = {
    languages_expert: data.skills?.Languages_Expert || [
      'JavaScript',
      'TypeScript',
    ],
    backend_expert: data.skills?.Backend_Expert || ['Fastify', 'HapiJS'],
    frontend_expert: data.skills?.Frontend_Expert || [
      'React',
      'UmiJs',
      'Ant Design',
      'MobX',
    ],
    languages_intermediate: data.skills?.Languages_Intermediate || [
      'Go',
      'Python',
    ],
    backend_intermediate: data.skills?.Backend_Intermediate || [
      'Gin',
      'Fiber',
      'WebSockets (Melody)',
    ],
    python: data.skills?.Python || ['Django', 'Odoo'],
    frontend_intermediate: data.skills?.Frontend_Intermediate || [
      'XState',
      'Next.js',
    ],
    ...
    monitoring: data.skills?.Monitoring || [
      'Grafana',
      'Prometheus',
      'Loki',
      'Promtail',
                ...
                <div>
                  ...
                  <Paragraph style={{ fontSize: '16px', lineHeight: 1.7 }}>
                    {data.about.description ||
                      "With 6 years of experience in software engineering, I've evolved from a curious developer into a technical leader who bridges the gap between complex technical concepts and business outcomes."}
                  </Paragraph>

                  <Paragraph style={{ fontSize: '16px', lineHeight: 1.7 }}>
                    I'm the engineer who thrives in the space between ambitious
                    goals and real-world constraints. My approach is simple:
                    understand the problem deeply, challenge assumptions
                    relentlessly, and build solutions that actually work. I
                    don't chase the latest framework hype or over-engineer for
                    imaginary scale. Instead, I focus on what matters - shipping
                    reliable systems that solve real problems and create lasting
                    impact.
                  </Paragraph>

                  <Paragraph style={{ fontSize: '16px', lineHeight: 1.7 }}>
                    {data.about.expertise ||
                      'My exceptional analytical and problem-solving skills, combined with a focus on system architecture and technical leadership, enable me to design solutions that reduce costs while improving maintainability, scalability, and performance.'}
                  </Paragraph>
                </div>
                ...
                <div>
                  ...
                  >
                    <div>
                      ...
                      <br />
                      <Text type="secondary">
                        Civil Engineering isn't just my degree - it's my
                        thinking framework. The analytical rigor and systematic
                        approach that others might miss comes naturally.
                      </Text>
                    </div>
                    <div>
                      ...
                      <br />
                      <Text type="secondary">
                        Top-notch ability to analyze businesses holistically.
                        Given context, I can read between the lines and
                        understand the real problems beyond technical
                        requirements.
                      </Text>
                    </div>
                    <div>
                      ...
                      <br />
                      <Text type="secondary">
                        Fast adaptation while maintaining depth. I quickly
                        identify patterns and apply proven solutions across
                        different contexts.
                      </Text>
                    </div>
                    <div>
                      ...
                      <br />
                      <Text type="secondary">
                        See the forest AND the trees. I understand how
                        individual decisions ripple through entire systems,
                        enabling transformative improvements.
                      </Text>
                    </div>
                  </Space>
                </div>
                ...
                <Col xs={24} md={12}>
                  <Card bordered={false} style={{ backgroundColor: '#f8f9fa' }}>
                    <Space direction="vertical" size="small">
                      ...
                      <Text type="secondary">
                        {data.about.university || 'Universitas Indonesia'}
                      </Text>
                      <Text>{data.about.educationYear || '2013 - 2018'}</Text>
                      <Paragraph style={{ marginTop: '8px', marginBottom: 0 }}>
                        Strong foundation in analytical thinking,
                        problem-solving, and systematic approach to complex
                        challenges.
                      </Paragraph>
                    </Space>
                  </Card>
                ...
                <Col xs={24} md={12}>
                  <Card bordered={false} style={{ backgroundColor: '#f8f9fa' }}>
                    <Space direction="vertical" size="small">
                      ...
                      <Text type="secondary">
                        {data.about.bootcamp || 'GarageScript (c0d3.com)'}
                      </Text>
                      <Text>
                        {data.about.bootcampYear || 'July - August 2018'}
                      </Text>
                      <Paragraph style={{ marginTop: '8px', marginBottom: 0 }}>
                        Career transition program focusing on full-stack
                        development, marking the beginning of my software
                        engineering journey.
                      </Paragraph>
                    </Space>
                  </Card>
          ...
          <Col xs={24}>
            ...
            >
              ...
              >
                ...
                >
                  When I'm not tinkering with technical challenges, you'll find
                  me gaming, coffe chilling and reading books to continuously
                  learn and stay inspired.
                </Paragraph>
